...
export default function PrayerApp() {
  ...
  // Load and shuffle prayer data each session
  useEffect(() => {
            ...
            {({ geographies }) =>
              geographies.map((geo) => {
                ...
                const ALIASES = {
                  ...
                  "central african republic central africa": "central african republic",
                  "chad central africa": "chad",
                  "columbia south america": "colombia",
                  "cuba caribbean": "cuba",
                  "democratic republic of the congo central africa": "democratic republic of the congo",
                  "egypt africa": "egypt",
                ...
                return (
                  <Geography
                    ...
                    style={{
                      ...
                      hover: { fill: isCurrent ? "#b11a1a" : "#cfcfcf" }, // no color change on hover
